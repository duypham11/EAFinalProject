...
INSERT INTO Username(username,UID,password,enabled) VALUES ('khlok.samphors@live.com','c298d333-2151-4668-ba49-1d8b74c76fea','store123', TRUE);
...
INSERT INTO Role (username, role) VALUES ('khlok.samphors@live.com', 'ROLE_STORE');
...
INSERT INTO  Store (name,firstname, lastname,username,note,email,address,phone) VALUES ('Panda Chinese Food','Sam','Khlok','khlok.samphors@live.com', 'great store', 'khlok.samphors@live.com','address 1 2 3','1012212122');
...
INSERT INTO Parcel (address, customerName, trackNumber, store_id, rider_id, status_id,email) VALUES ('304 W.Hempstead Avenue Fairfield, IA', 'Josh Stark', "123456", 1, 2, 2,'khlok.samphors@gmail.com');
...
INSERT INTO Parcel (address, customerName, trackNumber, store_id, rider_id, status_id,email) VALUES ('123 E 25th Street Mt Plesant, IA', 'Bob Brother', "87659", 1, 2, 3,'dp12@gmail.com');
